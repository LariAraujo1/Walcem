...
HEAD:frontend/src/components/politicsPage/privacy-policy.js


           
a5902d3023f107766de5b7e078068a71596e5e72:privacy-policy.html
    ...
    <footer>
        ...
        <div class="newsletter">
            <form action="#" method="POST">
                <label for="email">Assine nossa Newsletter:</label>
                <input type="email" id="email" name="email" placeholder="Seu email">
                <button type="submit">Assinar</button>
            </form>
        </div>
    </footer>
    <p class="copyright">Copyright 2024 WALCEM. Todos os direitos reservados.</p>
 
    <script src="js/privacy-scripts.js"></script>
</body>
</html>
a5902d3023f107766de5b7e078068a71596e5e72:privacy-policy.html
